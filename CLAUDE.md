...
| Compiler base | `newtonschool/judge0-newton-compiler:0.26` | what we layer on |
...
docker buildx build --platform linux/arm64 \
  -f NewtonDockerfile -t newtonschool/newton-judge0:0.33 --load .
...
- Current production tag: `0.32` (compiler base 0.25)
- Phase-2 modernisation tag: `0.33` (compiler base 0.26)
